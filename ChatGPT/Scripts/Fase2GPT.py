...
url = "http://192.168.0.10:4567/validate"



def add_profile_to_API(profile):
    response = requests.post("http://192.168.0.10:4567/profiles", profile)
            ...
            if prompt_type == "few_shot_basic" :      
                ...
                """
                     ...
                     prompt = f'''I will provide you a few examples of serialized data and the corresponding FHIR resource. Your task is to generate a FHIR resource based on the information about the patient .     
                                  ...
                                  - Ensure to do not include fields in the resource for you do not have information. 
...
def process_json(contador,prompt_type,profile, file_path, output_path, continue_line=None):
    ...
    for line in lines:
            ...
            if prompt_type == "few_shot_basic" :      
                ...
                '''+'''
                ##Mapping instructions:
                -Only when the field "discharge_location" is present, you must include the field "dischargeDisposition" in the resource.
                -The "intime" key corresponds to the "start" key in the location field.
                -The "outtime" key corresponds to the "end" key in the location field.
                -For this data : "careunit": "Coronary Care Unit (CCU)", "intime": "2141-05-22 20:18:01-04:00", "outtime": "2141-05-27 22:24:02-04:00" . You must generate the following:
                    "location":[
                        {
                          "period":{
                              "end":"2141-05-27T22:24:02-04:00",
                              "end":"2141-05-22T20:18:01-04:00",
                          },
                          "location":{
                              "reference":"Location/Coronary Care Unit (CCU)"
                          }
                        },                
...
#generate_and_validate_fhir_resource("few_shot_basic", profile, "Plain Text", "SerializedData/serialized_encounter_txt.json","GPT3/Encounter/resultados_few_shot_gpt_txt_2.ndjson")
generate_and_validate_fhir_resource("iterative_prompt", profile, "JSON", "SerializedData/serialized_encounter_json.json","GPT3/Encounter/resultados_iterative_encounter_json.ndjson",93)
