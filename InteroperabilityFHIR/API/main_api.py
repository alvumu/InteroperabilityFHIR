...
async def cluster_attributes_endpoint(
    ...
    try:
        attribute_path = "Fase3/data/enriched_attribute_descriptions_SK.json" # Input for clustering
        # Define the output path where clustering results will be saved (and RAG will read from)
        cluster_output_path = "Fase3/clustering/output/only_clusters_resQ_sk.json"
...
async def retrieve_resources_endpoint(
    ...
    try:
        cluster_file_path = "Fase3/clustering/output/clusters_resQ_Sk_API_corrected.json"
        resource_path = "Fase3/data/datasetRecursosBase.ndjson"
        json_schemas_path = "Fase3/data/enriched_dataset_schemasBase.ndjson"
        ...
        rag_output_path = "Fase3/clustering/output/clusters_resQ_Sk_API_corrected.json" # New name
        try:
...
async def identify_attributes_llm_endpoint(
    ...
    #cluster_file_name: str = Query(default="only_clusters_resQ_sk.json", description="Filename of the cluster results JSON within 'Fase3/clustering/output/'.")
):
    """
    ...
    # --- Define File Paths ---
    base_data_path = "Fase3/data"
    base_output_path = "Fase3/clustering/output"
    llm_output_base = "Fase3/llm_output" # Separate output dir for LLM results
    ...
    structured_attributes_path = "Fase3/clustering/filtered_data_attributes.json" # Based on script variable 'path' + 'filename'
